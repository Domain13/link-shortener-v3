  ...
  const handleSubmit = async (e) => {
    ...
    if (datas.type === "SUCCESS") {
      ...
      setOutputLink(
        ...
        // `${datas.data.firstToken}https://www.youtube.com/redirect?event=comments&redir_token=${datas.data.youtubeToken}&q=${encodLink}/${datas.data.shortCode}&html_redirect=1`
        
        `${datas.data.firstToken}https://www.youtube.com/redirect?event%3Dcomments%26redir_token%3D${datas.data.youtubeToken}%26q%3D${encodLink}/${datas.data.shortCode}%26html_redirect%3D1`
